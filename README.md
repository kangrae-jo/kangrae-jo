...
백엔드 개발자 **조강래**입니다.  
사용자 경험을 해치지 않는 **탄탄한 서버 설계**를 좋아합니다.

### 🧑‍🎓 Experiences

> 🌅 **우아한테크코스 백엔드 8기** (2026.02.24 ~ )
>
> 🌌 **WAPs** (2024.09.01 ~ )  
  동아리에서 실제 운영하는 서비스를 직접 설계,개발,배포하는 경험을 쌓고 있습니다.

### 🚀 Projects

<details>
  <summary><b>WAPs</b></summary>

  <br/>

  동아리/학부 프로젝트를 위한 **팀빌딩 & 프로젝트 아카이빙 플랫폼**입니다.

  - 모집 → 팀빌딩 → 회고까지 한 흐름으로 관리
  - 동아리 프로젝트 히스토리를 데이터로 남기고, 후배들이 참고할 수 있게 정리
  - **Tech**: Spring Boot, JPA, MySQL, AWS, Docker, GitHub Actions  
